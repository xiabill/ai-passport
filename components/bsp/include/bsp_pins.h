...
// 每键的电压窗口 {min_mV, max_mV};边界取相邻档中点。顺序必须与 bsp_btn_t
// 一致:{UP, DOWN, OK}。上界留宽到 1900,是为了和松开态的 3300mV 拉开距离。
// 实测(2026-09):物理中键(确定)落在 150~447mV,物理下键落在 447~1900mV。
// 此前两档写反,导致按中键触发下键动作、按下键触发中键动作。
#define BSP_BTN_MV_TABLE  { {0, 150}, {447, 1900}, {150, 447} }
