...
- Complete setup, build, flash, BLE protocol, and troubleshooting guide: [docs/development/vibe-typeless.en.md](docs/development/vibe-typeless.en.md)
- Chinese guide: [docs/development/vibe-typeless.md](docs/development/vibe-typeless.md)
...
On first launch, follow the in-app setup checks. Grant Bluetooth and Accessibility/Input Monitoring, install BlackHole 2ch, then select matching keys in Typeless, Doubao, and Bridge. The detailed [user guide](docs/releases/v0.3.12-vibe-typeless.en.md) covers installation, permissions, key mappings, firmware flashing, and troubleshooting.
...
The firmware requires ESP-IDF 5.5.3 and an ESP32-C3 board. Follow the [full guide](docs/development/vibe-typeless.en.md) before flashing an existing device: the merged image must not overwrite the protected `cardid` partition.
