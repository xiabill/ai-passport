...
On first launch, follow the in-app setup checks. Grant Bluetooth and Accessibility/Input Monitoring, install BlackHole 2ch, then select matching keys in Typeless, Doubao, and Bridge. The detailed [user guide](docs/releases/v0.3.2-vibe-typeless.en.md) covers installation, permissions, key mappings, firmware flashing, and troubleshooting.
