...
首次启动时按应用内检查逐项授权：蓝牙、辅助功能/输入监控，安装 BlackHole 2ch，并让 Typeless、豆包和 Bridge 使用一致的快捷键。详细的[用户教程](docs/releases/v0.3.2-vibe-typeless.zh_CN.md)包含安装、授权、按键映射、刷机和排错说明。
