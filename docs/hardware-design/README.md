...
- 产品规格维护在 `specifications.md`；固件行为与约束维护在硬件指南中。
...
| 文档 | 读者与权威范围 |
| --- | --- |
| [AI_HARDWARE_DEVELOPMENT_GUIDE.md](AI_HARDWARE_DEVELOPMENT_GUIDE.md) | BSP 行为、资源所有权、约束、验收与排障参考。 |
| [specifications.md](specifications.md) | 对外产品规格。 |
