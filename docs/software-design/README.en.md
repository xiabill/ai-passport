...
No topic-specific software design is registered yet. The authoritative AI entry point is [AGENTS.en.md](../../AGENTS.en.md); collaboration rules are under `docs/contribution/`, engineering rules under `docs/development/`, and fork workflow in `docs/fork-guide.en.md`.
