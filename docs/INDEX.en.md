...
| [releases/v0.3.10-vibe-typeless.en.md](releases/v0.3.10-vibe-typeless.en.md) | Download, install, configure, flash, and troubleshoot the Vibe Typeless release | authoritative |
...
| [development/CI-sync-main.en.md](development/CI-sync-main.en.md) | Fork upstream synchronization | authoritative |
| [development/publish-to-community.en.md](development/publish-to-community.en.md) | Publish firmware to the AI Passport community market | authoritative |
| [development/project-completion.en.md](development/project-completion.en.md) | Project completion flow (optional closing actions) | authoritative |
| [development/file-issues.en.md](development/file-issues.en.md) | Filing a suggestion as an upstream GitHub issue | authoritative |
| [development/experience-notes.en.md](development/experience-notes.en.md) | Index of development experience entries under `docs/experiences/` | reference |
| [fork-guide.en.md](fork-guide.en.md) | Fork branch and documentation workflow | authoritative |
...
| [software-design/README.en.md](software-design/README.en.md) | Software-design document index | reference |
| [../plays/INDEX.en.md](../plays/INDEX.en.md) | Index of archived applications in `plays/` | reference |
