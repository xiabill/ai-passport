<p align="right">
  <strong>简体中文</strong> · <a href="CI-sync-main.en.md">English</a>
</p>
...
- 同步目标与上游分支均为 `main`，与 fork 用户约定（`main` 仅允许修改根目录 `README.en.md` 与 `docs/assets/`）配合使用：`main` 保持与上游最新基线同步、不产生冲突。
