<p align="right">
  <strong>简体中文</strong> · <a href="readme-update.en.md">English</a>
</p>

# 动作 E：更新根 README

本动作更新 fork 在相关分支上的根 `README.en.md`，反映新发布或归档的应用。它是[项目开发完成流程](../project-completion.en.md)列出的六项可选动作之一。

根 README 路径特意留给 fork 所有者。上游的项目概览位于 `docs/README.en.md`；fork 可以添加自己的根 README 来解释其产品，而不替换上游文档。
...
- 只动 fork 所有的根 README（`README.en.md` / `README.md`）；不修改 `docs/README.en.md` 的上游项目概览。
...
- 遵循仓库语言规则：默认 `.md` 用简体中文，配对的 `.en.md` 用英文，同一变更内对齐。
...
- 应用归档 skill：[plays-archive](../../../skills/plays-archive/SKILL.en.md)
- 文档规范：[doc-conventions.en.md](../../contribution/doc-conventions.en.md)
