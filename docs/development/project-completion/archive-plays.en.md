<p align="right">
  <a href="archive-plays.md">简体中文</a> · <strong>English</strong>
</p>
...
- [Published profile](../project-completion.en.md#published-profile): bilingual title and
...
2. Generate a bilingual AI-functional summary under
   `plays/<username>/<app-name>/` (`README.md` / `README.en.md`), merging the root
...
4. Handle each branch's root README independently (see
   [readme-update.en.md](./readme-update.en.md) for the required README sync).
...
- Application archive convention: [plays/README.en.md](../../../plays/README.en.md)
- Skill: [plays-archive](../../../skills/plays-archive/SKILL.en.md)
- README update (required): [readme-update.en.md](./readme-update.en.md)
