...
| --- | --- | --- | --- |
| OK single click | start/stop Typeless Dictate | stop the current Typeless mode | ignored to prevent takeover |
| OK double click | start Typeless Translation | ignored | ignored |
| OK long press | start Typeless Ask anything | ignored | ignored |
...
| Event | device → Mac | `1` Typeless Dictate start, `2` Typeless stop, `3` Return, `4` legacy cancel/Escape, `5` Doubao start, `6` Doubao stop, `7` Doubao stop and send Return, `8` Typeless Translation start, `9` Typeless Ask anything start |
