<p align="right">
  <strong>简体中文</strong> · <a href="commit-and-pr.en.md">English</a>
</p>
...
- 仅用户可见的行为、兼容性和发布流程变化需要更新 `docs/CHANGELOG.md`；内部重构、CI 维护、拼写修复和依赖锁刷新不强制记录。
...
- PR body 使用英文，至少填写 `.github/PULL_REQUEST_TEMPLATE.en.md` 中的摘要、兼容性和验证结果。
