<p align="right">
  <a href="commit-and-pr.md">简体中文</a> · <strong>English</strong>
</p>
...
- Update `docs/CHANGELOG.en.md` only for user-visible behavior, compatibility, or release-flow changes.
...
- Write the PR body in English and complete `.github/PULL_REQUEST_TEMPLATE.en.md`.
