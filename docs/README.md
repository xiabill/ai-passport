...
| Low power | VIBE dims after 18 seconds, turns off the backlight after 60 seconds, and enters deep sleep after 15 minutes idle; GPIO0 button wake | `main/vibe_power.c`, `main/demo_low_power.c` | Deep sleep restarts the application; VIBE wake depends on the board's ADC button ladder |
