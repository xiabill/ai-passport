...
- 完整安装、构建、刷机、BLE 协议和排错教程：[docs/development/vibe-typeless.md](docs/development/vibe-typeless.md)
- English guide：[docs/development/vibe-typeless.en.md](docs/development/vibe-typeless.en.md)
...
首次启动时按应用内检查逐项授权：蓝牙、辅助功能/输入监控，安装 BlackHole 2ch，并让 Typeless、豆包和 Bridge 使用一致的快捷键。详细的[用户教程](docs/releases/v0.3.4-vibe-typeless.en.md)包含安装、授权、按键映射、刷机和排错说明。
...
固件需要 ESP-IDF 5.5.3 和 ESP32-C3 设备。给已有设备刷机前请阅读[完整教程](docs/development/vibe-typeless.md)：合并固件不能覆盖受保护的 `cardid` 分区。
