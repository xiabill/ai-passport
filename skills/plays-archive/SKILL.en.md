...
(see `docs/development/publish-to-community.en.md` for publishing itself) and only
...
[`../../plays/README.en.md`](../../plays/README.en.md) for the full convention.
...
- `git ls-tree --name-only main README.en.md` — is there a README on `main`?
- `test -f README.en.md` — is there a README on the current branch?

Follow the repository rule that the root README path is reserved for the fork
owner (see `docs/fork-guide.en.md`); do not create a root README unless the fork
actually owns one.
...
submitted), then write `plays/<username>/<app-name>/README.en.md` and its paired
`.en.md` as an AI-generated functional summary for later querying (not a
...
Write the default `.md` in Simplified Chinese and the `.en.md` in English,
...
[`docs/assets/brand/`](../../docs/assets/brand/README.en.md): pass a reference (e.g.
...
convention in [`docs/assets/brand/README.en.md`](../../docs/assets/brand/README.en.md).
...
- Application archive convention: `../plays/README.en.md`
- Post-release follow-up overview: `docs/development/project-completion.en.md`
